...
var CircularProgress = React.createClass({displayName: "CircularProgress",
  ...
  render: function() {
    var $__0=
      ...
      this.props,style=$__0.style,size=$__0.size,other=(function(source, exclusion) {var rest = {};var hasOwn = Object.prototype.hasOwnProperty;if (source == null) {throw new TypeError();}for (var key in source) {if (hasOwn.call(source, key) && !hasOwn.call(exclusion, key)) {rest[key] = source[key];}}return rest;})($__0,{style:1,size:1});

    
    var styles = this.getStyles(size || 1);

    return (
      React.createElement("div", React.__spread({},   other, {style: this.mergeAndPrefix(styles.root, style)}), 
        React.createElement("div", {ref: "wrapper", style: this.mergeAndPrefix(styles.wrapper)}, 
          React.createElement("svg", {style: this.mergeAndPrefix(styles.svg)}, 
